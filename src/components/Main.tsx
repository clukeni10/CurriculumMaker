...
function Main(){
    return (
        ...
        <Box flex="1" flexDirection="column" bg="white" color="#5A7D9A" p={6} display="flex" alignItems="center" justifyContent="center" gap="5" >
          ...
          <Button size="md" variant="subtle"  bg="#5A7D9A" 
            _hover={{ bg: "white", color: "#5A7D9A", borderColor: "#5A7D9A" }} 
            transition="color 0.3s"
            color="white">Criar Currículo <LuArrowRight />
          </Button>
        </Box>
      </Flex>
    )
